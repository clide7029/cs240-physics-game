...
class Game {
    ...
    constructor() {
        ...
        let floor = Matter.Bodies.rectangle(Game.WIDTH_RATIO * Game.WORLD_SCALE / 2, Game.FLOOR_HEIGHT + 250, Game.WIDTH_RATIO * Game.WORLD_SCALE, 500, { isStatic: true, label: "Ground", friction: 1, render: { opacity: 0.5 } });

        Matter.Composite.add(this.engine.world, [this.generator.getWorld(Game.WIDTH_RATIO, Game.WORLD_SCALE, Game.FLOOR_HEIGHT), floor, this.slingShot, this.slingShot.bodyB, this.mouseConstraint])
